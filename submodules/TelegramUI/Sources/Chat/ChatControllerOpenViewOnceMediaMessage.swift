...
extension ChatControllerImpl {
    func openViewOnceMediaMessage(_ message: EngineMessage) {
        let ghostBaseAllowOneTimeScreenRecording = (((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeScreenRecording") as? Bool) ?? false) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.Enabled") as? Bool) ?? true) && message.id.peerId.namespace != Namespaces.Peer.SecretChat)
