...
final class ChatPinnedMessageTitlePanelNode: ChatTitleAccessoryPanelNode {
    ...
    override func updateLayout(width: CGFloat, leftInset: CGFloat, rightInset: CGFloat, transition: ContainedViewLayoutTransition, interfaceState: ChatPresentationInterfaceState) -> LayoutResult {
        ...
        self.captureProtected = !(((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenshots") as? Bool) ?? true) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenRecording") as? Bool) ?? true)) && (interfaceState.copyProtectionEnabled || interfaceState.myCopyProtectionEnabled)
