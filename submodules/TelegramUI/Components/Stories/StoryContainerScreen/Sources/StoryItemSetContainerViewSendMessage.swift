...
//        component.controller()?.push(controller)
    ...
    private func ghostBaseStoryEffectiveScheduleTime(_ scheduleTime: Int32?) -> Int32? {
        return (((SecretGramHotSettings.object(forKey: "secretgram.GhostMode.ScheduledSend") as? Bool) ?? false) && scheduleTime == nil) ? Int32(Date().timeIntervalSince1970) + 12 : scheduleTime
    }
