    ...
    final class View: StoryContentItem.View {
                ...
                if self.videoNode == nil {
                    let videoNode = UniversalVideoNode(
                        ...
                        content: NativeVideoContent(
                            ...
                            tempFilePath: nil,
                            captureProtected: !(((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenshots") as? Bool) ?? true) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenRecording") as? Bool) ?? true)) && component.item.isForwardingDisabled,
        ...
        private func updateOverlays(component: StoryItemContentComponent, size: CGSize, synchronousLoad: Bool, transition: ComponentTransition) {
            self.overlaysView.update(
                ...
                size: size,
                isCaptureProtected: !(((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenshots") as? Bool) ?? true) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenRecording") as? Bool) ?? true)) && component.item.isForwardingDisabled,
