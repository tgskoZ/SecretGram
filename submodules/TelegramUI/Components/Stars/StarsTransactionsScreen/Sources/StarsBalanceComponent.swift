...
private func ghostBaseLocalStarsAmountForDisplay() -> StarsAmount? {
    guard ((UserDefaults.standard.object(forKey: "secretgram.Stars.LocalBalance.Enabled") as? Bool) ?? false) else {
        return nil
    }
    guard let rawValue = UserDefaults.standard.object(forKey: "secretgram.Stars.LocalBalance.Amount") as? String else {
        return nil
    }
