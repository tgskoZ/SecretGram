...
private func secretgramMainSettingsIcon(
    _ name: String
) -> UIImage? {
...
func settingsItems(data: PeerInfoScreenData?, context: AccountContext, presentationData: PresentationData, interaction: PeerInfoInteraction, isExpanded: Bool) -> [(AnyHashable, [PeerInfoScreenItem])] {
    ...
    PeerInfoScreenDisclosureItem(
        id: 0,
        text: presentationData.strings.secretgram.settingsTitle,
        icon: secretgramMainSettingsIcon("SecretGram/Settings/Airplane"),
        action: {
    ...
    PeerInfoScreenDisclosureItem(
        id: 1,
        text: presentationData.strings.secretgram.ghostMode,
        icon: secretgramMainSettingsIcon("Chat/Context Menu/Eye"),
        action: {
            UserDefaults.standard.set(
                "ghostMode",
                forKey: "secretgram.Settings.InitialPage"
    ...
    PeerInfoScreenDisclosureItem(
        id: 2,
        text: presentationData.strings.secretgram.messages,
        icon: secretgramMainSettingsIcon("Chat/Context Menu/MessageBubble"),
        action: {
            UserDefaults.standard.set(
                "messages",
                forKey: "secretgram.Settings.InitialPage"
    ...
    PeerInfoScreenDisclosureItem(
        id: 3,
        text: presentationData.strings.secretgram.protectedContent,
        icon: secretgramMainSettingsIcon("Premium/CopyProtection/NoForward"),
        action: {
            UserDefaults.standard.set(
                "protectedContent",
                forKey: "secretgram.Settings.InitialPage"
    ...
    PeerInfoScreenDisclosureItem(
        id: 4,
        text: presentationData.strings.secretgram.mediaAndStories,
        icon: secretgramMainSettingsIcon("Item List/Icons/Stories"),
        action: {
            UserDefaults.standard.set(
                "mediaStories",
                forKey: "secretgram.Settings.InitialPage"
    ...
    PeerInfoScreenDisclosureItem(
        id: 5,
        text: presentationData.strings.secretgram.appearance,
        icon: secretgramMainSettingsIcon("Chat/Context Menu/ApplyTheme"),
        action: {
            UserDefaults.standard.set(
                "appearance",
                forKey: "secretgram.Settings.InitialPage"
    ...
    PeerInfoScreenDisclosureItem(
        id: 6,
        text: presentationData.strings.secretgram.debugResearch,
        icon: secretgramMainSettingsIcon("Chat/Context Menu/FormatCode"),
        action: {
            UserDefaults.standard.set(
                "debugResearch",
                forKey: "secretgram.Settings.InitialPage"
    ...
    PeerInfoScreenDisclosureItem(
        id: 7,
        text: presentationData.strings.secretgram.about,
        icon: secretgramMainSettingsIcon("Chat/Context Menu/Info"),
        action: {
            UserDefaults.standard.set(
                "about",
                forKey: "secretgram.Settings.InitialPage"
...
func settingsEditingItems(data: PeerInfoScreenData?, state: PeerInfoState, context: AccountContext, presentationData: PresentationData, interaction: PeerInfoInteraction, isMyProfile: Bool) -> [(AnyHashable, [PeerInfoScreenItem])] {
    ...
    if case let .user(user) = data.peer {
        items[.info]!.append(PeerInfoScreenDisclosureItem(id: ItemPhoneNumber, label: .text(((UserDefaults.standard.object(forKey: "secretgram.Appearance.HideOwnPhone") as? Bool) ?? false) ? "" : (user.phone.flatMap({ formatPhoneNumber(context: context, number: $0) }) ?? "")), text: presentationData.strings.Settings_PhoneNumber, icon: PresentationResourcesSettings.recentCalls, action: {
            interaction.openSettings(.phoneNumber)
        }))
    }
    var username = ""
