            ...
            component: AnyComponent(HorizontalTabsComponent(
                ...
                tabs: availablePanes.map { paneKey -> HorizontalTabsComponent.Tab in
                    ...
                    case .gifts:
                        ...
                        canReorder = true
                    case .ghostBaseProfileHistory:
                        content = .title(HorizontalTabsComponent.Tab.Title(text: presentationData.strings.secretgram.profileHistoryTab, entities: [], enableAnimations: false))
                    case .ghostBasePresence:
                        content = .title(HorizontalTabsComponent.Tab.Title(text: presentationData.strings.secretgram.presenceHistoryTab, entities: [], enableAnimations: false))
                    case .ghostBaseGiftHistory:
                        content = .title(HorizontalTabsComponent.Tab.Title(text: presentationData.strings.secretgram.giftHistoryTab, entities: [], enableAnimations: false))
                    case .ghostBasePersonalChannel:
                        content = .title(HorizontalTabsComponent.Tab.Title(text: presentationData.strings.secretgram.personalChannelTab, entities: [], enableAnimations: false))
                    case .polls:
