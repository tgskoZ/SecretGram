...
private enum GhostBaseProfileReportStoreV11G {
    static let queue = DispatchQueue(
        label: "secretgram.ProfileReportStore.V11G",
        qos: .utility
    )
    ...
    static func profileKey(accountPeerId: Int64, peerId: Int64) -> String {
        return "secretgram.ProfileHistory.V11G.\(accountPeerId).\(peerId)"
    }
    ...
    static func personalChannelKey(accountPeerId: Int64, peerId: Int64) -> String {
        ...
        return "secretgram.ProfileIntel3.PersonalChannel.\(accountPeerId).\(peerId)"
    }
