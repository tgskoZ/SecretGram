...
public final class ChatSearchNavigationContentNode: NavigationBarContentNode {
    ...
    private let secretgramTimeMachineBackground: GlassBackgroundView
    private let secretgramTimeMachineLabel: UILabel
    ...
    public init(context: AccountContext, theme: PresentationTheme, strings: PresentationStrings, chatLocation: ChatLocation, interaction: ChatPanelInterfaceInteraction, presentationInterfaceState: ChatPresentationInterfaceState) {
        ...
        self.secretgramTimeMachineBackground = GlassBackgroundView()
        self.secretgramTimeMachineLabel = UILabel()
        self.secretgramTimeMachineLabel.textAlignment = .center
        self.secretgramTimeMachineLabel.font = UIFont.systemFont(ofSize: 13.0, weight: .semibold)
        ...
        self.view.addSubview(self.secretgramTimeMachineBackground)
        self.secretgramTimeMachineBackground.contentView.addSubview(self.secretgramTimeMachineLabel)
        self.secretgramTimeMachineBackground.contentView.addGestureRecognizer(
            UITapGestureRecognizer(target: self, action: #selector(self.secretgramOpenTimeMachine))
        )
    ...
    override public func updateLayout(size: CGSize, leftInset: CGFloat, rightInset: CGFloat, transition: ContainedViewLayoutTransition) -> CGSize {
        ...
        self.secretgramTimeMachineLabel.text = self.strings.secretgram.timeMachine
        self.secretgramTimeMachineLabel.textColor = self.theme.chat.inputPanel.panelControlColor
        transition.setFrame(view: self.secretgramTimeMachineBackground, frame: timeMachineFrame)
        self.secretgramTimeMachineBackground.update(
        ...
        self.secretgramTimeMachineLabel.frame = CGRect(origin: .zero, size: timeMachineFrame.size)
    ...
    @objc private func secretgramOpenTimeMachine() {
