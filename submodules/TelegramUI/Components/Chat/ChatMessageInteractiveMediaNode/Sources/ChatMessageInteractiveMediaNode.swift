...
public final class ChatMessageInteractiveMediaNode: ASDisplayNode, GalleryItemTransitionNode {
    ...
    public func asyncLayout() -> (_ context: AccountContext, _ presentationData: ChatPresentationData, _ dateTimeFormat: PresentationDateTimeFormat, _ message: Message, _ associatedData: ChatMessageItemAssociatedData,  _ attributes: ChatMessageEntryAttributes, _ media: Media, _ mediaIndex: Int?, _ dateAndStatus: ChatMessageDateAndStatus?, _ automaticDownload: InteractiveMediaNodeAutodownloadMode, _ peerType: MediaAutoDownloadPeerType, _ peerId: EnginePeer.Id?, _ sizeCalculation: InteractiveMediaNodeSizeCalculation, _ layoutConstants: ChatMessageItemLayoutConstants, _ contentMode: InteractiveMediaNodeContentMode, _ presentationContext: ChatPresentationContext) -> (CGSize, CGFloat, (CGSize, Bool, Bool, ImageCorners) -> (CGFloat, (CGFloat) -> (CGSize, (ListViewItemUpdateAnimation, Bool) -> Void))) {
        ...
        return { [weak self] context, presentationData, dateTimeFormat, message, associatedData, attributes, media, mediaIndex, dateAndStatus, automaticDownload, peerType, peerId, sizeCalculation, layoutConstants, contentMode, presentationContext in
            ...
            let ghostBaseOneTimeVisualBypass = (((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.Enabled") as? Bool) ?? true) && ((((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeScreenshots") as? Bool) ?? false) || ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeScreenRecording") as? Bool) ?? false) || ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeSave") as? Bool) ?? false))) && message.minAutoremoveOrClearTimeout != nil && message.id.peerId.namespace != Namespaces.Peer.SecretChat)
                    ...
                    return (boundingSize, { transition, synchronousLoads in
                        if let strongSelf = self {
                                ...
                                if currentReplaceVideoNode, let updatedVideoFile = updateVideoFile {
                                    ...
                                    if useInlineHLS && NativeVideoContent.isHLSVideo(file: updatedVideoFile) {
                                        ...
                                        videoContent = NativeVideoContent(
                                            ...
                                            captureProtected: isExtendedMedia || (!(((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenshots") as? Bool) ?? true) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenRecording") as? Bool) ?? true)) && (associatedData.isCopyProtectionEnabled || message.isCopyProtected())),
                            ...
                            if let updateImageSignal = updateImageSignal {
                                strongSelf.imageNode.captureProtected = isExtendedMedia || (!(((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenshots") as? Bool) ?? true) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.AllowScreenRecording") as? Bool) ?? true)) && (associatedData.isCopyProtectionEnabled || message.isCopyProtected()))
    ...
    private func updateStatus(animated: Bool) {
        ...
        if isSecretMedia {
            ...
            if let remainingTime {
                let secretgramOutgoingTimedMediaViewed = (
                    ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.Enabled") as? Bool) ?? true)
                    && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeSave") as? Bool) ?? false)
                ...
                if remainingTime == viewOnceTimeout {
                    ...
                    let secretgramOneTimeBadgeText = secretgramOutgoingTimedMediaViewed ? "1 ✓" : "1"
                    badgeContent = .text(inset: 10.0, backgroundColor: messageTheme.mediaDateAndStatusFillColor, foregroundColor: messageTheme.mediaDateAndStatusTextColor, text: NSAttributedString(string: secretgramOneTimeBadgeText), iconName: "Chat/Message/SecretMediaOnce")
                } else {
                    let secretgramTimedBadgeText = strings.MessageTimer_ShortSeconds(Int32(remainingTime)) + (secretgramOutgoingTimedMediaViewed ? " ✓" : "")
                    badgeContent = .text(inset: 10.0, backgroundColor: messageTheme.mediaDateAndStatusFillColor, foregroundColor: messageTheme.mediaDateAndStatusTextColor, text: NSAttributedString(string: secretgramTimedBadgeText), iconName: "Chat/Message/SecretMediaPlay")
                }
            }
        }
