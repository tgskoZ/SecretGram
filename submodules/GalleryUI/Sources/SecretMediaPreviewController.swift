...
public final class SecretMediaPreviewController: ViewController {
        ...
        if self.screenCaptureEventsDisposable == nil {
            ...
            |> deliverOnMainQueue).start(next: { [weak self] _ in
                if let strongSelf = self, strongSelf.traceVisibility() {
                    let ghostBaseAllowOneTimeScreenshots = (((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeScreenshots") as? Bool) ?? false) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.Enabled") as? Bool) ?? true) && strongSelf.messageId.peerId.namespace != Namespaces.Peer.SecretChat)
    ...
    @objc private func ghostBaseSaveCurrentTimedMedia() {
        ...
        let ghostBaseTimedPreviewSave = (((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.Enabled") as? Bool) ?? true) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeSave") as? Bool) ?? false) && message.id.peerId.namespace != Namespaces.Peer.SecretChat && message.paidContent == nil && message.minAutoremoveOrClearTimeout != nil)
    ...
    private func applyMessageView() {
        ...
        if let message = message {
            ...
            if self.currentNodeMessageId != message.id {
                ...
                let ghostBaseAllowOneTimeSave = (((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeSave") as? Bool) ?? false) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.Enabled") as? Bool) ?? true) && message.id.peerId.namespace != Namespaces.Peer.SecretChat && message.paidContent == nil)
                ...
                let ghostBaseKeepOneTimeLocal = (((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.Enabled") as? Bool) ?? true) && ((SecretGramHotSettings.object(forKey: "secretgram.ProtectedContent.OneTimeSave") as? Bool) ?? false) && message.minAutoremoveOrClearTimeout != nil && message.id.peerId.namespace != Namespaces.Peer.SecretChat)
