...
private enum GhostBasePresenceStoreV11G {
    static let queue = DispatchQueue(
        label: "secretgram.PresenceStore.V11G",
        qos: .utility
    )
    ...
    static func historyKey(accountPeerId: PeerId, peerId: PeerId) -> String {
        return "secretgram.PresenceHistory1.\(accountPeerId.toInt64()).\(peerId.toInt64())"
    }

    static func knownUserIdsKey(_ accountPeerId: PeerId) -> String {
        return "secretgram.PresenceGlobal1.KnownUserIds.\(accountPeerId.toInt64())"
    }

    static func knownUserKey(accountPeerId: PeerId, peerId: PeerId) -> String {
        return "secretgram.PresenceGlobal1.KnownUser.\(accountPeerId.toInt64()).\(peerId.toInt64())"
    }
