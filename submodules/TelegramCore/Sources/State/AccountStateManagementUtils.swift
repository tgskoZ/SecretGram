...
private enum GhostBaseRuntimeDiagnosticsV11G {
    private static let queue = DispatchQueue(
        label: "secretgram.RuntimeDiagnostics.V11G",
        qos: .utility
    )
    private static let key = "secretgram.Runtime.Diagnostics.V11G"
...
func ghostBaseIsBotAccount(_ accountPeerId: PeerId) -> Bool {
    return UserDefaults.standard.bool(
        forKey: "secretgram.BotAccount.\(accountPeerId.toInt64())"
    )
}
        ...
        switch operation {
            ...
            case let .DeleteMessagesWithGlobalIds(ids):
                ...
                let ghostBaseSaveDeleted = ghostBaseMessageIds.allSatisfy { id in
                    SecretGramRetentionRuntime.shouldCapture(
                        ...
                        legacyToggleKey: "secretgram.Messages.SaveDeleted"
                    )
                }
                ...
                if ghostBaseSaveDeleted {
                    for id in ghostBaseMessageIds {
                        transaction.updateMessage(id, update: { currentMessage in
                            ...
                            SecretGramCaptureRecorder.record(
                                accountPeerId: accountPeerId.toInt64(),
                                ...
                                payload: SecretGramEventPayload(text: currentMessage.text)
                            )
            ...
            case let .EditMessage(id, message):
                ...
                transaction.updateMessage(id, update: { previousMessage in
                    ...
                    let ghostBaseSaveEditHistory = SecretGramRetentionRuntime.shouldCapture(
                        accountPeerId: accountPeerId.toInt64(),
                        chatPeerId: id.peerId.toInt64(),
                        isSecretChat: id.peerId.namespace == Namespaces.Peer.SecretChat,
                        legacyToggleKey: "secretgram.Messages.SaveEditHistory"
                    )
