...
enum GhostBaseV10EPushProbeCore {
    static func record(_ name: String, amount: Int = 1) {
        ...
        let prefix = "secretgram.V10E.Push."
    ...
    static func set(_ key: String, _ value: String) {
        UserDefaults.standard.set(value, forKey: "secretgram.V10E.Push." + key)
    }
    static func count(_ name: String) -> Int {
        return UserDefaults.standard.integer(forKey: "secretgram.V10E.Push." + name + ".Count")
    }
