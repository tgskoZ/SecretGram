...
public enum GhostBaseGlassStyle {
    public static let enabledKey = "secretgram.Glass.Enabled"
...
public struct GhostBaseProfileBlurSettings: Equatable {
    public static let avatarBlurKey = "secretgram.ProfileBlur.Avatar"
    public static let animatedKey = "secretgram.ProfileBlur.Animated"
    public static let tintKey = "secretgram.ProfileBlur.Tint"
    public static let reducedKey = "secretgram.ProfileBlur.Reduced"
