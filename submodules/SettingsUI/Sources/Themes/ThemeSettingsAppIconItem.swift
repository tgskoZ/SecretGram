                ...
                if let strongSelf = self {
                    ...
                    for icon in item.icons {
                        ...
                        if let image = UIImage(named: icon.imageName, in: getAppBundle(), compatibleWith: nil) {
                            ...
                            var bordered = true
                            switch icon.name {
        case "SecretGramGlassReveal":
            name = "Glass Reveal"
        case "SecretGramGlassSolid":
            name = "Glass Solid"
        case "SecretGramSteelReveal":
                                    name = "Steel"
                                case "SecretGramSteelSolid":
                                    name = "Steel Solid"
                                case "SecretGramRustReveal":
                                    name = "Rust"
                                case "SecretGramRustSolid":
                                    name = "Rust Solid"
                                case "SecretGramInkReveal":
                                    name = "Ink"
                                case "SecretGramInkSolid":
                                    name = "Ink Solid"
                                case "SecretGramOliveReveal":
                                    name = "Olive"
                                case "SecretGramOliveSolid":
                                    name = "Olive Solid"
                                case "BlueIcon":
