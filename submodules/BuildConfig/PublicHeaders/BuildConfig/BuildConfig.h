...
@interface BuildConfig (SecretGramExtensionDiagnostics)
+ (NSString * _Nonnull)secretgramExtensionContainerClassificationForPath:(NSString * _Nullable)path
    NS_SWIFT_NAME(secretgramExtensionContainerClassification(path:));
+ (NSString * _Nonnull)secretgramExtensionBoundarySummaryWithProcess:(NSString * _Nonnull)process
    stage:(NSString * _Nonnull)stage
    path:(NSString * _Nullable)path
    NS_SWIFT_NAME(secretgramExtensionBoundarySummary(process:stage:path:));
+ (void)secretgramRecordExtensionDiagnosticWithProcess:(NSString * _Nonnull)process
    stage:(NSString * _Nonnull)stage
    ...
    NS_SWIFT_NAME(secretgramRecordExtensionDiagnostic(process:stage:appGroupIdentifier:sharedContainerPath:detail:));
+ (NSString * _Nonnull)secretgramExtensionDiagnosticsReport;
