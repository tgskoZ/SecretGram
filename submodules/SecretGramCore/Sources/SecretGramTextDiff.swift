...
public enum SecretGramTextDiffOperation: Equatable {
    case equal(String)
    case insert(String)
    case delete(String)
...
public enum SecretGramTextDiff {
    public static func diff(old: String, new: String) -> [SecretGramTextDiffOperation] {
        ...
        var primitive: [SecretGramTextDiffOperation] = []
        var i = 0
        var j = 0
    ...
    private static func coalesce(
        _ operations: [SecretGramTextDiffOperation]
    ) -> [SecretGramTextDiffOperation] {
        var grouped: [SecretGramTextDiffOperation] = []
        ...
        var result: [SecretGramTextDiffOperation] = []
        var index = 0
