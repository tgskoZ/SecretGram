...
final class AuthorizationSequencePasswordEntryControllerNode: ASDisplayNode, UITextFieldDelegate {
    ...
    init(strings: PresentationStrings, theme: PresentationTheme, mode: AuthorizationSequencePasswordEntryMode = .password) {
        ...
        self.titleNode.attributedText = NSAttributedString(string: mode == .ghostBaseBotToken ? strings.secretgram.botLoginTitle : strings.LoginPassword_Title, font: Font.semibold(28.0), textColor: self.theme.list.itemPrimaryTextColor)
        ...
        self.noticeNode.attributedText = NSAttributedString(string: mode == .ghostBaseBotToken ? strings.secretgram.botTokenNotice : strings.TwoStepAuth_EnterPasswordHelp, font: Font.regular(17.0), textColor: self.theme.list.itemPrimaryTextColor, paragraphAlignment: .center)
    ...
    func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
        ...
        self.titleNode.attributedText = NSAttributedString(string: self.mode == .ghostBaseBotToken ? self.strings.secretgram.botLoginTitle : self.strings.LoginPassword_Title, font: Font.semibold(28.0), textColor: self.theme.list.itemPrimaryTextColor)
